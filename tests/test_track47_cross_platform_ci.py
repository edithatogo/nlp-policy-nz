...
TRACK47 = ROOT / "conductor" / "tracks" / "archive" / "track47_cross_platform_ci_20260626"
...
def test_track47_registry_and_plan_are_in_sync() -> None:
    """Track 47 should be recorded as archived with matrix and binary scope."""
    ...
    assert "./conductor/tracks/archive/track47_cross_platform_ci_20260626/" in registry
