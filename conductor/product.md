...
- **Relational Graphing & Search**: Local LanceDB-backed semantic search without external vector services, optional FAISS benchmarking, and relational graph modeling using NetworkX to map connections between parliamentary speeches and enacted laws.
