...
- Task 2 remains partially open because the current implementation intentionally avoids claiming true Levenshtein/Jaro-Winkler/embedding execution until those libraries or model indexes are introduced. The fuzzy scorer is deterministic and offline.
- Task 5 remains open pending a real embedding model/index implementation and corpus-scale nearest-neighbour evaluation.
