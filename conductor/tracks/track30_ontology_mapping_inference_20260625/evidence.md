...
- Added `src/nlp_policy_nz/ontology/mapping_inference.py` with deterministic inference helpers for exact normalized alias overlap, fuzzy lexical similarity, supplied synonym groups, structural neighbourhood overlap, embedding-vector cosine similarity, method-agreement scoring, candidate manifests, and optional LLM prompt contracts.
