...
- [ ] Cross-surface conformance matrix exists and is generated from the capability registry.
- [ ] CI detects registry, CLI, API, SDK, MCP, and docs drift.
- [ ] Public docs include CLI, API, SDK, MCP, deprecation, and compatibility references.
- [ ] Release checklist covers interface contract versioning and project mirror updates.
