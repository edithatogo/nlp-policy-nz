...
- [x] Baseline benchmark JSON committed to `artifacts/baselines/`
- [x] CI benchmark step compares PR results against baseline
- [x] CI fails if any benchmark regresses >10% (configurable per test)
- [x] Master merge workflow updates baselines automatically
- [x] HTML benchmark report uploaded as CI artifact
- [x] Documentation in `docs/perf_regression.md`
