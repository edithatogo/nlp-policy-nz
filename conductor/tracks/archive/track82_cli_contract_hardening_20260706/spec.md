...
- [x] Public CLI contract is documented and generated from the live parser or capability registry.
- [x] Golden tests cover help text, command parsing, exit codes, JSON outputs, and failure paths.
- [x] Commands map back to Track 81 capability IDs.
- [x] Shell completion and manpage/reference docs are refreshed and validated in CI.
