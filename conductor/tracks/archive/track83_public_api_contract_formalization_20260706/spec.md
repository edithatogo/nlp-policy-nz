...
- [x] Versioned OpenAPI artifact is generated, checked, and documented.
- [x] API endpoint and SDK capability mapping is validated against Track 81.
- [x] Contract tests cover success, auth, validation failure, RFC 7807 errors, and client SDK parity.
- [x] API lifecycle, versioning, and deprecation policy are documented.
