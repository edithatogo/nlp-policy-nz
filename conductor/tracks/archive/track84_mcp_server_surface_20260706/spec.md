...
- [x] Optional MCP server module and entrypoint exist without adding a mandatory runtime dependency.
- [x] Read-only MCP tools and resources are mapped to Track 81 capability IDs.
- [x] Contract tests exercise MCP tool schemas and representative tool calls with fixture data.
- [x] Docs cover local MCP client configuration, safety boundaries, and disabled write/publish capabilities.
