...
- [x] Provenance recorder captures pipeline version, model version, parameters, timestamps
- [x] PROV-O JSON-LD export is valid against PROV-O schema
- [x] Sidecar `.prov.json` file created for each Parquet output
- [x] `provenance` CLI subcommand displays provenance info
- [x] Zenodo deposit includes provenance metadata
- [x] Test coverage > 90%
