...
- [x] Docs site deploys automatically on master merge
- [x] API reference auto-generated from OpenAPI spec + Python docstrings
- [x] All user guides from Scope 3 are written and linked from site home page
- [x] Architecture diagrams (C4 level 2) explain all major subsystems
- [x] 3+ tutorial notebooks render correctly in the docs site
- [x] Runbook covers deploy, backup, restore, and failure recovery
- [x] Docs versioned per git tag; "latest" points to master
