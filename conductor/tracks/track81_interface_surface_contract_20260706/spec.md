...
- [ ] Capability inventory covers CLI, FastAPI, SDK, rules-as-code exports, quality reports, search, provenance, and multi-engine parity.
- [ ] A machine-readable interface contract exists with stable IDs, schemas, auth/scope metadata, side-effect classification, and owner modules.
- [ ] Adapter gap report identifies duplicated logic and missing core functions.
- [ ] Decision record confirms the core-library-first adapter model for CLI, API, and MCP surfaces.
