...
- [ ] KB contains 200+ MPs, all parties, all electorates
- [ ] Entity resolver links spans to KB with >85% precision
- [ ] Wikidata SPARQL enrichment works with caching
- [ ] Parquet output includes `resolved_entities` column
- [ ] Test coverage > 90%
