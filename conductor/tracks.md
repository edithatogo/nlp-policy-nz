...
- **Parallelization Node**: Evidence Intake, Archive Assurance, and Jurisdiction Onboarding
- **Why**: Collect the rights, evaluation, assurance, conformance, and jurisdiction-source evidence required to move the remaining roadmap issues from repository scaffolds to reviewable, promotion-safe outputs.
