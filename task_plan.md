...
**Status**: Complete except full verification

- [x] **Task 3.1: Add deontic fields to serialization**
  - Add `deontic_modality` and `legal_effect` fields to `PipelineRecord` in `storage/serialization.py`.
- [x] **Task 3.2: Update legislation processor**
  - Update `process_legislation()` in `api.py` to run modality detector.
- [x] **Task 3.3: Update Parquet schema**
