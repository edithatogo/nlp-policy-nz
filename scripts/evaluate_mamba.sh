...
if [ "${1:-}" = "--audit" ]; then
  ...
  printf '%s\n' "Live Mamba evaluation is intentionally disabled in this repo-side audit wrapper." >&2
...
printf '%s\n' "track21 architecture audit: mamba-3 (${mode}); no clone, download, training, or Hub push will be started." >&2
