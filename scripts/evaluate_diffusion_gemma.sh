...
if [ "${1:-}" = "--audit" ]; then
  ...
  printf '%s\n' "Live DiffusionGemma evaluation is intentionally disabled in this repo-side audit wrapper." >&2
...
printf '%s\n' "track21 architecture audit: diffusion-gemma (${mode}); no clone, download, training, or Hub push will be started." >&2
